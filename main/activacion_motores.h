 ...
 */
motorController motor(encoderBPin, encoderAPin,
                      motorEnabePWMPin,
                      motorPhasePin,
                      motorSleepPin,
                      POSICION_MAXIMA_MOTOR,
                      POSICION_MINIMA_MOTOR);
...
void iniciaEncoder()
{
  attachInterrupt(encoderAPin, updateMotores, CHANGE);
}
